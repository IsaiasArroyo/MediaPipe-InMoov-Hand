...
def limitar_velocidad(actual, objetivo, paso=3):
...
while True:
    ...
    if res.multi_hand_landmarks:
        ...
        target_thumb  = map_servo(thumb,117,160,180,0)
        target_index  = map_servo(index,0,173,180,0)
        target_middle = map_servo(middle,4,175,180,0)
        target_ring   = map_servo(ring,8,176,180,0)
        target_pinky  = map_servo(pinky,22,178,180,0)
